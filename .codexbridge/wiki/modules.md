...
- Functions/symbols: run_long_horizon_interference_experiment, validate_long_horizon_interference_result, _build_family_a_ledger, _pretrain_family_a, _run_condition, _effective_learning_rate, _pair_score, _canonical_snapshot, _config_snapshot, _validate_memory_snapshot, _memory_snapshot_payload, _ledger_snapshot, _validate_ledger_snapshot, _memory_family_score, _condition_expected_consolidation, _condition_replay_bounded_from_summary, _condition_replay_bounded, _condition_replay_sources_resolved, _condition_integrity_predicate, _validate_condition_result_semantics, _clamp_signed, _validate_unit, _validate_signed, _validate_code
