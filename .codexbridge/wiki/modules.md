...
- Kind: python
- Classes: CandidateGenerationTruncationReason, BoundedCandidateGenerationConfig, ImaginedCandidateGenerationRequest, ImaginedCandidateGenerationStep, ImaginedGeneratedCandidate, ImaginedCandidateGenerationResult, BoundedExactCandidateGenerator, _CandidatePrefixState
- Functions/symbols: _candidate_from_steps, _canonical_json_bytes, _identity, _effect_snapshot, _validate_ascii_code, _validate_sorted_unique_codes, _validate_effects, _validate_zero_delta
...
- Kind: python
- Classes: ImaginedRoutePairRelation, ImaginedRouteDimensionRelation, ImaginedRouteIncomparabilityReason, BoundedRouteComparisonConfig, ImaginedRouteComparisonRequest, ImaginedRouteDimensionComparison, ImaginedRoutePairComparison, ImaginedRouteComparisonResult, BoundedImaginedRouteComparator
- Functions/symbols: _compare_dimension, _dimension_relation, _pair_relation, _need_dimensions, _required_dimension_comparison_count, _comparison_keys, _step_at, _alignment_for, _direction_order, _sorted_reasons, _canonical_json_bytes, _identity, _validate_ascii_code, _validate_index, _validate_sorted_unique_enum_values, _validate_dimension_side_shape, _validate_signed_nonzero, _validate_positive_unit, _validate_signed, _validate_unit, _validate_zero_delta
...
- Functions/symbols: _revalidate_source_result, _canonical_json_bytes, _identity, _validate_ascii_code, _validate_bounded_ascii_code, _validate_positive_int, _validate_zero_delta
...
- Kind: python
- Classes: ImaginedSafeExperimentReviewMode, ImaginedSafeExperimentReviewGateStatus, BoundedSafeExperimentReviewGateConfig, ImaginedSafeExperimentReviewGateRequest, ImaginedSafeExperimentReviewGateDecision, ImaginedSafeExperimentReviewGateResult, BoundedImaginedSafeExperimentReviewGate
- Functions/symbols: _status_for, _validate_status_shape, _revalidate_proposal_result, _revalidate_permission_result, _canonical_json_bytes, _identity, _validate_ascii_code, _validate_bounded_ascii_code, _validate_positive_int, _validate_zero_delta
...
- Kind: python
- Classes: ImaginedComparisonIssueScope, BoundedComparisonUncertaintyConfig, ImaginedComparisonUncertaintyRequest, ImaginedComparisonUncertaintyIssue, ImaginedComparisonUncertaintyResult, BoundedImaginedComparisonUncertaintyAuditor
- Functions/symbols: _issue_payload, _revalidate_source_result, _canonical_json_bytes, _identity, _validate_ascii_code, _validate_index, _validate_sorted_unique_reasons, _validate_unique_ascii_codes, _validate_zero_delta
...
- Kind: python
- Classes: ProposalRiskLevel, ProposalOutcomeStatus, StageSevenConscienceConfig, ProtectedProhibition, TypedActionProposal, ResponsibilityLearningEvidence, AuthorityInterruptionEvidence, IntegrityProtectionEvidence, ProtectedGatewayTestDoubleEvidence, StageSevenConscienceEvidence
- Functions/symbols: run_stage_seven_conscience_acceptance, _validate_non_empty_sequence, _validate_positive_int, _validate_non_negative_int, _validate_zero_int, _validate_unit, _validate_ascii_code, _validate_sorted_unique_ascii_codes, _identity, _canonical_json_bytes
...
- Kind: python
- Classes: DevelopmentalSignalRole, DESARoutingDisposition, MetacognitiveSummaryScope, StewardGateDecision, EventPartitionOperation, ValueSourceKind, CapabilityGapSource, SkillBundleLifecycle, OutcomeFidelityState, OutcomeFeedbackSource, ProtectedAuthorityAction, IntegritySurface, IntegrityManipulationKind, NurseryCurriculumKind, CausalResponsibilityEvidenceKind, CausalResponsibilityStatus, DevelopmentalSignalContract, OptionalSkillStewardGate, DESAHierarchyContract, ChronologicalActivityEvent, EventPartitionRecord, EventPartitionLedger, DESARoutingScenario, RegionalCalibrationEvidence, MetacognitiveSummary, ExecutiveAuditorFinding, DesiredStateValueSource, CapabilityGapEvidence, DesiredStateAmbitionContract, OutcomeFeedbackRecord, DevelopmentalOutcomeFidelityContract, DevelopmentalSkillBundleContract, FeedbackIterationContract, ProtectedAuthoritySignal, AuthorityInterruptionOutcome, IntegrityManipulationAttempt, IntegrityProtectionDecision, CausalResponsibilityCandidate, NurseryCurriculumScenario, StageMinusOneAcceptanceEvidence
- Functions/symbols: evaluate_integrity_attempt, stage_minus_one_signal_contracts, stage_minus_one_nursery_curriculum, run_stage_minus_one_acceptance, _validate_curriculum_sequence, _validate_index, _validate_positive_int, _validate_zero_int, _validate_unit, _validate_zero_delta, _validate_non_negative_finite, _validate_ascii_code, _validate_non_empty_ascii_codes, _validate_sorted_unique_ascii_codes, _validate_sorted_unique_enum_values, _validate_non_empty_sequence, _identity, _canonical_json_bytes

## `src/seedmind/research/ndnra/developmental_desa_bootstrap.py`

Stage 1A DESA bootstrap evidence over the Stage 1 substrate.

- Kind: python
- Classes: DESABootstrapStrategy, DESABootstrapConfig, RegionalCaptainContribution, DESAWorkspaceCoalition, DESABootstrapRoutingDecision, DESARoutingStrategyResult, SkillBundleLearningEvidence, ExecutiveAuditorCorrectionEvidence, EventBoundaryRecallEvidence, DESAVerifierCalibrationEvidence, StageOneADESABootstrapEvidence
- Functions/symbols: run_stage_one_a_desa_bootstrap_acceptance, _validate_non_empty_sequence, _validate_positive_int, _validate_zero_int, _validate_unit, _validate_non_negative_finite, _validate_ascii_code, _validate_sorted_unique_ascii_codes, _identity, _canonical_json_bytes
...
- Kind: python
- Classes: CoalitionDormancyState, StageSixLoadStatus, StageSixHibernationConfig, HibernatingCoalitionState, DreamReplayRecord, RecallRestorationEvidence, StageSixRestartLoadResult, StageSixRestartProof, StageSixHibernationEvidence
- Functions/symbols: run_stage_six_hibernation_acceptance, save_stage_six_hibernation_evidence, load_stage_six_hibernation_evidence, prove_stage_six_restart, _coalitions, _restore_evidence, _restore_coalition, _mapping, _sequence, _str, _int, _float, _validate_non_empty_sequence, _validate_positive_int, _validate_non_negative_int, _validate_zero_int, _validate_unit, _validate_signed_unit, _validate_ascii_code, _validate_sorted_unique_ascii_codes, _identity, _checksum, _canonical_json_bytes, _canonical_json_text
...
- Kind: python
- Classes: HomeostasisControlCondition, ExpansionProposalStatus, StageFiveHomeostasisConfig, HomeostaticCoalitionState, HomeostasisControlResult, IdleCapacityRecruitmentEvidence, SaturationObservation, StructuralExpansionProposal, StageFiveHomeostasisEvidence
- Functions/symbols: run_stage_five_homeostasis_acceptance, _coalitions, _controls, _saturation_observations, _validate_non_empty_sequence, _validate_positive_int, _validate_non_negative_int, _validate_zero_int, _validate_unit, _validate_ascii_code, _validate_sorted_unique_ascii_codes, _identity, _canonical_json_bytes
...
## `src/seedmind/research/ndnra/developmental_regions.py`

Stage 3 specialised concurrent regions and multiple-need evidence.

- Kind: python
- Classes: DevelopmentalRegionKind, CrossRegionMessageKind, DevelopmentalRegionConfig, DevelopmentalRegionState, ConcurrentNeedPulse, CrossRegionMessage, RegionalProposal, ConcurrentNeedActivationResult, StageThreeRegionalConcurrencyEvidence
- Functions/symbols: run_stage_three_regional_concurrency_acceptance, build_stage_three_region_states, _compatible_task_resource_result, _protected_preservation_result, _dormant_curiosity_reemergence_result, _validate_non_empty_sequence, _validate_positive_int, _validate_non_negative_int, _validate_zero_int, _validate_unit, _validate_ascii_code, _validate_sorted_unique_ascii_codes, _identity, _canonical_json_bytes

## `src/seedmind/research/ndnra/developmental_shadow_trial.py`

Stage 8 end-to-end software-only shadow trial evidence.

- Kind: python
- Classes: ShadowTaskFamily, ShadowOutcomeState, DESAShadowDisposition, StageEightShadowConfig, ShadowBaselineAction, ShadowProposalObservation, DESAShadowTrace, NeedRepresentationEvidence, LearnedSkillSurvivalEvidence, AmbitionCapabilityGapEvidence, TemporarySkillIncubationEvidence, OldTaskRetentionEvidence, ResourceBudgetEvidence, InspectabilityEvidence, StageEightShadowTrialEvidence
- Functions/symbols: run_stage_eight_shadow_trial_acceptance, _safe_proposal, _proposal_observation, _desa_traces, _need_evidence, _validate_non_empty_sequence, _validate_positive_int, _validate_non_negative_int, _validate_zero_int, _validate_unit, _validate_ascii_code, _validate_sorted_unique_ascii_codes, _identity, _canonical_json_bytes
...
## `src/seedmind/research/ndnra/long_horizon_interference_experiment.py`

Deterministic long-horizon mixed-task interference experiment for NDNRA.

- Kind: python
- Classes: LongHorizonInterferenceCondition, LongHorizonTaskFamily, LongHorizonInterferenceConfig, LongHorizonStepRecord, LongHorizonConditionResult, LongHorizonInterferenceResult, LongHorizonInterferenceEvidence, _LongHorizonMemory
- Functions/symbols: run_long_horizon_interference_experiment, validate_long_horizon_interference_result, long_horizon_interference_payload, restore_long_horizon_interference_result, _build_family_a_ledger, _pretrain_family_a, _run_condition, _effective_learning_rate, _pair_score, _canonical_snapshot, _config_snapshot, _restore_long_horizon_config, _validate_memory_snapshot, _memory_snapshot_payload, _restore_memory_snapshot, _ledger_snapshot, _validate_ledger_snapshot, _restore_step_record, _restore_condition_result, _restore_mastery_profile, _restore_consolidation_candidate, _memory_family_score, _condition_expected_consolidation, _condition_replay_bounded_from_summary, _condition_replay_bounded, _condition_replay_sources_resolved, _condition_integrity_predicate, _validate_condition_result_semantics, _clamp_signed, _validate_unit, _validate_signed, _validate_code, _require_mapping, _require_list, _require_bool, _require_ascii, _require_optional_ascii, _require_nonnegative_int, _require_positive_int, _require_exact_int, _require_nonnegative_float, _require_unit, _require_signed, _require_optional_unit, _require_ascii_list, _require_int_list, _require_finite_list, _require_enum

## `src/seedmind/research/ndnra/long_horizon_interference_persistence.py`

Isolated persistence and restart proof for long-horizon interference Batch 2.

- Kind: python
- Classes: LongHorizonInterferenceLoadStatus, LongHorizonInterferenceSaveResult, LongHorizonInterferenceLoadResult, LongHorizonInterferenceAuthorityReport, LongHorizonInterferenceDeltaReport, LongHorizonInterferenceRestartProofResult
- Functions/symbols: save_long_horizon_interference_result, load_long_horizon_interference_result, prove_long_horizon_interference_restart, validate_long_horizon_interference_restart_proof_result, _expected_pass_gate, _canonical_restart_proof_snapshot, _envelope_payload, _failed_load, _checksum_payload, _canonical_ascii_json, _json_ready, _require_mapping, _require_ascii, _require_int, _require_sha256, _validate_sha256, _remove_temporary_file, _zero_authority, _zero_deltas, _authority_is_zero, _deltas_are_zero
...
- Kind: python
- Functions/symbols: _context, _observation, _generator, _request, _predictable_model, test_exact_one_step_records_generate_candidates_in_deterministic_action_order, test_exact_bounds_do_not_report_false_truncation_when_enumeration_is_complete, test_exact_two_step_continuity_emits_prefix_before_extension_in_bfs_order, test_multiple_parents_preserve_deterministic_bfs_order, test_every_step_and_candidate_is_imagined_and_preserves_exact_provenance, test_reversed_action_order_remains_distinct_when_exact_continuity_supports_both, test_near_match_context_that_would_require_transfer_yields_zero_candidates, test_observed_chain_only_or_transferred_evidence_cannot_become_generation_source, test_missing_requested_effects_and_missing_exact_next_context_block_admission, test_unavailable_actions_block_admission, test_repeated_source_prediction_ids_stop_cycle_extension, test_runtime_bounds_are_deterministic_and_non_mutating, test_request_bounds_fail_before_prediction_where_possible_and_leave_model_unchanged, test_repeated_identical_generation_requests_produce_identical_ids_and_ascii_snapshots, test_ordinary_unsupported_context_returns_empty_non_truncated_result, test_generated_sequences_can_be_explicitly_handed_to_batch1_without_implicit_call, test_generated_candidate_types_cannot_update_real_consequence_evidence, test_static_ast_import_checks_prove_no_forbidden_subsystem_dependencies, test_snapshots_exclude_scoring_selection_schedule_execution_and_promotion_fields, snapshot_json
...
- Kind: python
- Functions/symbols: _context, _observe, _need, _result_for, _comparison, _two_step_result, test_left_strictly_dominates_right_without_hidden_route_score, test_right_dominance_is_symmetric, test_conflicting_tradeoffs_are_incomparable, test_unknown_alignment_blocks_dominance, test_zero_confidence_known_alignment_is_low_confidence_by_default, test_configured_confidence_floor_blocks_low_confidence_comparison, test_different_route_depths_are_incomparable, test_two_neutral_alignments_with_different_raw_values_remain_equivalent, test_improving_and_worsening_alignments_compare_by_signed_magnitude, test_identical_alignment_vectors_with_distinct_provenance_remain_separate, test_duplicate_evaluation_ids_are_rejected, test_source_result_caller_order_cannot_be_rewritten, test_dimension_comparison_rejects_incomplete_source_shape, test_pair_relation_must_match_dimension_relations, test_result_rejects_tampered_pair_source_reference, test_mixed_active_needs_are_rejected_atomically, test_alignment_semantic_mismatches_are_rejected_atomically, test_effect_set_mismatch_is_rejected_atomically, test_empty_source_result_returns_deterministic_empty_result, test_bounds_reject_atomically, test_pair_order_is_deterministic_caller_index_order, test_repeated_requests_have_stable_ascii_identities_and_source_ids_resolve, test_zero_deltas_and_authority_remain_exact_on_all_layers, test_actual_comparison_objects_cannot_update_real_consequence_evidence, test_snapshots_exclude_scoring_ranking_selection_and_execution_fields, test_static_ast_import_checks_exclude_forbidden_subsystems
...
## `tests/unit/test_ndnra_bounded_imagination_safe_experiment_permission.py`

Tests for explicit human review of imagined safe-experiment proposals.

- Kind: python
- Functions/symbols: _context, _need, _observe, _proposal_result, _request, _review, test_explicit_human_approval_preserves_exact_provenance_without_execution, test_reject_and_defer_are_explicit_non_permission_outcomes, test_approval_requires_every_explicit_acknowledgement, test_review_requires_explicit_human_identity, test_review_action_requires_explicit_permission_enum, test_proposal_and_required_permission_mismatches_are_rejected, test_tampered_source_result_is_rejected_before_review, test_permission_review_bounds_are_enforced_atomically, test_permission_config_requires_positive_integer_bounds, test_repeated_reviews_have_stable_ascii_identities, test_distinct_human_dispositions_produce_distinct_identities, test_zero_deltas_and_authority_remain_exact_on_every_layer, test_result_rejects_tampered_decision, test_permission_review_cannot_be_recorded_as_real_consequence_evidence, test_permission_module_has_no_runtime_persistence_or_selection_dependencies
...
## `tests/unit/test_ndnra_bounded_imagination_safe_experiment_review_gate.py`

Tests for explicit training review and configured non-training bypass.

- Kind: python
- Functions/symbols: _context, _need, _observe, _proposal_result, _permission_result, _resolve, test_training_without_review_remains_explicitly_required, test_training_approval_is_review_evidence_without_execution, test_training_reject_and_defer_remain_distinct_non_approval_outcomes, test_explicit_non_training_bypass_requires_enabled_policy, test_missing_review_is_never_an_implicit_bypass, test_training_bypass_is_forbidden_even_when_policy_capability_is_enabled, test_non_training_bypass_must_be_enabled_and_explicitly_identified, test_policy_code_without_bypass_request_is_rejected, test_bypass_cannot_be_combined_with_permission_evidence, test_permission_result_must_target_the_exact_proposal_result, test_review_gate_bounds_and_types_are_enforced, test_repeated_gate_resolutions_have_stable_ascii_identities, test_zero_deltas_and_authority_remain_exact_on_every_layer, test_result_rejects_tampered_gate_decision, test_review_gate_result_cannot_be_recorded_as_real_consequence_evidence, test_review_gate_has_no_execution_persistence_or_selection_dependencies

## `tests/unit/test_ndnra_bounded_imagination_stage_closure.py`

Closure audit for the complete bounded-imagination stage.

- Kind: python
- Functions/symbols: _modules, _module_source, test_stage_module_inventory_and_package_exports_are_complete, test_stage_modules_exclude_runtime_storage_and_background_dependencies, test_stage_modules_expose_no_execution_or_selection_entry_points, test_stage_dataclass_authority_and_learning_defaults_remain_zero, test_stage_sources_define_no_schema_worker_or_timer_surface
...
- Kind: python
- Functions/symbols: _context, _need, _observe, _comparison_result, _audit, _depth_mismatch_result, test_comparable_pair_emits_no_uncertainty_issue, test_unknown_alignment_emits_exact_dimension_issue, test_low_confidence_emits_dimension_issue, test_route_depth_mismatch_emits_dimension_issues, test_conflicting_tradeoff_emits_one_pair_issue_with_related_dimensions, test_issue_order_preserves_pair_and_dimension_order, test_empty_source_returns_deterministic_empty_audit, test_bounds_reject_atomically, test_tampered_source_result_is_rejected, test_result_rejects_tampered_issue_source_reference, test_repeated_requests_have_stable_ascii_identities, test_zero_deltas_and_authority_remain_exact_on_all_layers, test_uncertainty_objects_cannot_update_real_consequence_evidence, test_snapshots_exclude_scoring_proposals_selection_and_execution, test_static_dependencies_exclude_generation_execution_and_storage_surfaces
...
- Kind: python
- Functions/symbols: test_stage_seven_acceptance_matrix_complete_and_zero_side_effects, test_high_utility_prohibited_proposal_inhibited_and_safer_alternative_active, test_protected_prohibitions_immutable_and_reward_not_trainable, test_direct_teaching_contextual_refinement_reward_resistance_and_generalization, test_false_veto_and_correction_bounds, test_authority_interruptions_immediate_and_neutral, test_integrity_attempts_inhibited_recorded_and_evaluator_protected, test_typed_proposal_preserves_reasons_experiences_uncertainty_outcome_authority, test_gateway_test_double_never_grants_authority, test_stage_seven_deterministic_and_config_bounds, test_public_exports_cover_stage_seven_conscience, test_developmental_conscience_has_no_forbidden_runtime_dependencies
...
- Kind: python
- Functions/symbols: _hierarchy, _raw_events, _operations, _value_source, _gap, _pending_outcome, _verified_outcome, test_stage_minus_one_acceptance_matrix_is_complete_and_non_authoritative, test_public_exports_cover_stage_minus_one_contracts, test_event_partitioning_preserves_raw_chronology_and_rejects_rewrites, test_desa_hierarchy_rejects_hidden_solver_fixed_bureaucracy_and_authority, test_optional_steward_gate_is_measured_and_rejects_unjustified_layer, test_routing_scenarios_keep_plural_routing_and_escalation_explicit, test_metacognitive_summaries_are_bounded_and_do_not_control_the_network, test_ambition_requires_grounded_value_source_and_separate_capability_gaps, test_outcome_fidelity_requires_grounded_feedback_not_self_confirmation, test_skill_bundle_and_iteration_boundaries_are_explicit, test_protected_authority_is_reward_independent_and_non_mutating, test_integrity_tampering_is_blocked_preserved_and_non_evidentiary, test_causal_responsibility_cannot_promote_from_coactivation_alone, test_curricula_are_grounded_bounded_and_non_authoritative, test_developmental_constitution_has_no_forbidden_runtime_dependencies

## `tests/unit/test_ndnra_developmental_desa_bootstrap.py`

Tests for NDNRA v0.2 Stage 1A DESA bootstrap evidence.

- Kind: python
- Functions/symbols: test_stage_one_a_acceptance_matrix_is_complete_and_zero_authority, test_routing_resolves_local_work_and_escalates_uncertainty_conflict_and_failure, test_regional_captains_share_workspace_without_monopoly, test_minimal_desa_beats_shuffled_and_single_central_controls, test_optional_steward_and_feedback_learning_are_evidence_bound, test_temporary_skill_bundle_and_feedback_loop_remain_bounded, test_calibration_beats_raw_activation_and_producer_confidence, test_event_partitioning_preserves_raw_chronology_and_improves_recall, test_auditor_ambition_and_deterministic_identity_are_separate_and_reproducible, test_public_exports_cover_stage_one_a_desa_bootstrap, test_stage_one_a_rejects_failed_gate_and_forbidden_runtime_dependencies
...
- Kind: python
- Functions/symbols: test_stage_six_acceptance_matrix_is_complete_and_zero_authority, test_dormant_coalitions_preserve_structure_topology_and_provenance, test_recall_can_fail_shallow_but_restore_with_need_relation_or_dream, test_dream_replay_improves_access_without_evidence_or_actions, test_rare_important_protected_coalition_remains_retrievable_and_protected, test_stage_six_save_load_restores_exact_snapshot, test_stage_six_corrupt_checksum_and_schema_fall_back_completely, test_stage_six_restart_proof_covers_equivalence_and_fallback, test_hibernating_coalition_rejects_missing_structure_and_authority, test_stage_six_config_bounds_and_determinism, test_public_exports_cover_stage_six_hibernation, test_developmental_hibernation_has_no_forbidden_runtime_dependencies
...
- Kind: python
- Functions/symbols: test_stage_five_acceptance_matrix_is_complete_and_zero_authority, test_activation_settles_and_coalitions_remain_sparse_within_edge_budget, test_homeostasis_controls_show_inhibition_and_homeostasis_are_needed, test_idle_capacity_is_recruited_before_structural_expansion, test_one_anomaly_cannot_trigger_expansion_but_repeated_saturation_can, test_duplicate_expansion_is_rejected_and_budget_exhaustion_preserves_need, test_expansion_proposals_reject_missing_causal_evidence_and_authority, test_mutated_homeostasis_evidence_rejects_failed_pass_gates, test_homeostatic_coalition_rejects_capacity_and_edge_violations, test_stage_five_acceptance_is_deterministic_and_config_bounded, test_public_exports_cover_stage_five_homeostasis, test_developmental_homeostasis_has_no_forbidden_runtime_dependencies
...
## `tests/unit/test_ndnra_developmental_regions.py`

Tests for NDNRA v0.2 Stage 3 regional concurrency evidence.

- Kind: python
- Functions/symbols: test_stage_three_acceptance_matrix_is_complete_and_zero_authority, test_region_local_pools_are_distinct_and_safety_region_is_protected, test_compatible_needs_remain_simultaneous_and_cooperate_without_erasure, test_protected_need_inhibits_incompatible_task_without_action_authority, test_dormant_need_reemerges_after_blocking_need_resolves, test_stage_three_rejects_global_scalar_and_worse_region_local_control, test_cross_region_messages_are_typed_inspectable_and_validated, test_proposals_and_need_pulses_reject_authority_and_ambiguous_conflicts, test_results_validate_known_regions_needs_sorted_proposals_and_action_counters, test_stage_three_acceptance_is_deterministic_and_config_bounded, test_public_exports_cover_stage_three_regional_concurrency, test_developmental_regions_has_no_forbidden_runtime_dependencies
...
- Kind: python
- Functions/symbols: test_stage_eight_acceptance_matrix_complete_and_zero_authority, test_production_actions_cover_task_families_and_remain_baseline_fixed, test_shadow_proposals_are_context_sensitive_and_non_executable, test_desa_partitions_delegate_escalate_and_preserve_contributions, test_multiple_needs_remain_represented_and_prohibition_inhibits, test_skill_survives_maturation_dormancy_dream_and_restart, test_ambition_gap_decreases_and_temporary_skill_preserves_unverified_outcome, test_retention_resource_and_inspectability_bounds, test_stage_eight_deterministic_and_config_bounds, test_stage_eight_integrated_state_rejects_missing_coverage_and_mutation, test_public_exports_cover_stage_eight_shadow_trial, test_developmental_shadow_trial_has_no_forbidden_runtime_dependencies
...
## `tests/unit/test_ndnra_long_horizon_interference.py`

Tests for deterministic long-horizon mixed-task interference Batch 1.

- Kind: python
- Functions/symbols: test_old_family_is_mastered_and_eligible_before_horizon, test_all_conditions_use_exact_36_step_abac_schedule_with_contiguous_indices, test_family_a_probe_steps_do_not_mutate_memory, test_public_snapshots_are_transitively_immutable, test_no_consolidation_learns_b_and_c_while_degrading_old_family, test_naive_protection_retains_old_family_better_while_slowing_novel_learning, test_bounded_replay_uses_only_exact_candidate_sources_and_only_below_threshold, test_replay_bounds_floors_and_joint_advantage_hold, test_source_ledger_snapshot_trace_count_and_mastery_profile_remain_unchanged, test_zero_structural_drift_zero_authority_and_no_sqlite_hold, test_exact_rerun_equality_ascii_snapshot_and_sha256_identity_are_stable, test_config_rejects_invalid_bounds_and_horizon, test_nested_contract_validation_rejects_tampering, test_evidence_validation_rejects_source_snapshot_mismatch, test_static_dependency_exclusions_hold, _build_invalid_config, _rehashed_snapshot

## `tests/unit/test_ndnra_long_horizon_interference_persistence.py`

Tests for long-horizon interference persistence and restart proof.

- Kind: python
- Functions/symbols: test_store_round_trips_exact_result_and_writes_deterministic_ascii, test_restart_proof_includes_exact_reload_and_deterministic_rerun, test_plain_batch_1_result_keeps_restart_proof_false, test_missing_state_is_explicit_non_proof_fallback, test_malformed_json_and_non_ascii_are_corrupt_non_proof_fallback, test_checksum_and_identity_tampering_are_corrupt_even_with_valid_json, test_incompatible_schema_or_version_is_explicit_non_proof_fallback, test_unknown_envelope_top_level_and_nested_payload_fields_are_rejected, test_restore_rejects_wrong_enum_duplicate_ids_unsorted_memory_and_timeline_tampering, test_restore_rejects_semantic_score_pass_gate_authority_and_restart_flag_tampering, test_load_result_shape_cannot_claim_partial_or_authoritative_fallback, test_restart_proof_rejects_boundary_and_equivalence_tampering, test_restart_proof_rejects_snapshot_identity_and_pass_gate_tampering, test_persistence_module_is_isolated_from_disallowed_runtime_surfaces, _read_envelope, _write_envelope, _payload, _object, _list_of_objects, _list_of_strings, _payload_checksum, _clone, _test_directory
...
- Kind: python
- Functions/symbols: _context, _observation, _chain, _request, test_valid_two_step_real_chain_preserves_order_and_provenance, test_reversed_action_order_is_distinct_and_does_not_share_support, test_disconnected_contexts_are_rejected_atomically, test_one_event_cannot_appear_twice_in_one_chain, test_exact_duplicate_chain_is_ignored_without_multiplying_support, test_conflicting_reuse_of_chain_identity_is_rejected, test_source_event_identity_conflict_is_rejected_across_overlapping_chains, test_replay_and_imagined_steps_cannot_become_chain_evidence, test_depth_effect_dimension_and_total_chain_bounds_are_atomic, test_missing_effect_dimensions_remain_unknown, test_contradictory_chains_lower_confidence_and_remain_inspectable, test_overlapping_chains_do_not_count_as_fully_independent_support, test_unknown_action_sequence_returns_complete_uncertainty, test_exact_observed_order_may_predict_final_context_but_bridge_may_not, test_chain_prediction_does_not_mutate_exact_model_or_transfer_policy, test_candidate_limit_is_enforced_during_prediction_without_mutation, test_authority_configuration_and_request_contracts_are_enforced, test_chain_snapshots_are_deterministic_ascii_and_non_authoritative, test_chain_module_has_no_execution_storage_timer_or_transfer_dependency, test_transfer_predictions_cannot_be_inserted_as_chain_evidence
