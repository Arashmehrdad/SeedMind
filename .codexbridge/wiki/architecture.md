...
- `scripts/run_week11_specialist_growth.py` — functions: main
...
- `src/seedmind/growth/rollback.py` — classes: ModuleRegistration, GrowthRegistry; functions: initial_growth_registry
- `src/seedmind/growth/router.py` — classes: RoutingDecision, SpecialistRouter
- `src/seedmind/growth/specialist.py` — classes: CandidateStatus, SpecialistLatentState, ExpertModuleInput, ExpertModuleOutput, SpecialistProfile, CandidateSkillExpert; functions: _abstain, _desired_direction, _push_contact_effective, _lateral_positions, _shortest_route, _in_bounds, _opposite, _turn_or_push, _turn_or_move, _turn_toward
...
- `src/seedmind/growth/week12.py` — classes: Week12RunResult; functions: run_week12_consolidation, export_week12_evidence, _write_json
- `src/seedmind/growth/week12_evaluation.py` — classes: Week12EvaluationBundle; functions: evaluate_week12, _evaluate_replay, _evaluate_retention, _evaluate_navigation, _evaluate_help_and_correction, _evaluate_character_and_safety, run_general, run_routed, _general_proposal, _run_navigation
- `src/seedmind/growth/week12_gate.py` — classes: Week12Evidence; functions: run_week12_gate, _load_week11_candidate, _stable_checkpoint, _checkpoint_reload_pass, _growth_audit, _input_hashes, _implementation_hashes, _read_json, _sha256_file, _payload_digest
- `src/seedmind/growth/week12_scenarios.py` — classes: AngularTransferVariant, NavigationCase; functions: angular_transfer_state, navigation_state, scenario_catalogue, _boundary_walls, _position_json
