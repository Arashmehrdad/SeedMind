...
- `src/seedmind/research/ndnra/consolidation_proposal_persistence.py` — classes: NDNRAProposalLifecycleCheckpoint; functions: _restore_registry, _restore_managed_record, _restore_lifecycle_record, _restore_review_decision, _restore_management_decision, _restore_proposal, _restore_candidate, _restore_mastery_profile, _management_decision_id, _validate_replacement_links
