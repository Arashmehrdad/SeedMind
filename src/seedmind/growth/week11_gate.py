...
from seedmind.growth.specialist import CandidateSkillExpert, CandidateStatus
from seedmind.growth.week11_evaluation import (
    CUBE_GAIN_TARGET,
    FAMILIAR_RETENTION_FLOOR,
    evaluate_candidate,
)
from seedmind.growth.week11_inputs import WEEK8_SKILL, cube_like_state
...
def run_week11_gate() -> Week11Evidence:
    ...
    pass_fields: dict[str, bool] = {
        ...
        "incubation_provenance_pass": selected_rate > direct_rate,
    ...
    candidate_manifest = {
        ...
        "creation_provenance": {
            ...
            "selected_incubation_checkpoint": incubation["selected_checkpoint_sha256"],
        },
        "inputs": [
            "latent_state",
            "current_goal",
    ...
    graph = {
        ...
        "nodes": [
            {"active": True, "id": "predictive_seed_core", "type": "shared_state"},
            {"active": False, "id": "specialist_router", "type": "proposal_router"},
            {"active": True, "id": PARENT_MODULE, "type": "general_controller"},
            {
                "active": milestone_pass,
                "id": CANDIDATE_ID,
